...
/*
At line 51, data will be stored in Sessions Cache and the same data will be retrieved at line 54 (without reaching to DB).
Since function is Transactional, means a transaction is started so all the queries will be atomic or all will be executed at once.
So, without data being saved in db (at line 51 through save()) we can retrieve it (at line 54 through getReferenceById()) from cache only.
*/